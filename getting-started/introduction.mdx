...
<CardGroup cols={2}>
  <Card title="Conditional branching" icon="code-branch" href="/reference/branching">
    Skip or show groups of questions based on earlier answers.
  </Card>
  <Card title="Field validation" icon="check-double" href="/reference/validation">
    Validate phone numbers, date ranges, regex patterns, and custom rules.
  </Card>
  <Card title="Multiple question types" icon="list-check" href="/reference/question-types">
  ...
  <Card title="Version history" icon="clock-rotate-left">
    Every publish is saved. Restore or diff any past version.
  </Card>
</CardGroup>
