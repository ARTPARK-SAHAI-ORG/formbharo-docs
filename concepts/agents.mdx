---
title: "Agents: The Forms Your Voice Assistant Asks"
sidebarTitle: "Agents"
description: "An agent is a form plus the way it is asked — questions, scripts, and settings. Learn about draft and published states, versioning, and workspace membership."
---
...
This performs a **soft delete**. The agent stops appearing in list responses and can no longer accept new calls. However, all existing call records and their collected answers are fully preserved — nothing is erased from the database. If you need to recover a soft-deleted agent, contact support.
