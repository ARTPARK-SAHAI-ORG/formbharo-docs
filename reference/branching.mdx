---
title: "Conditional Branching for Voice Agent Questions"
sidebarTitle: "Branching"
description: "Ask a group of follow-up questions only when an earlier answer calls for them using FormBharo's branch system — declare branches, then tag questions with a branch_id."
---
